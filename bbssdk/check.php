		...
		if(file_exists($file)){
			...
			die('File Path Error!');
                ...
                if(isset($_REQUEST['share'])){//分享
                    ...
                    $threadUrl = get_site_url().'forum.php?mod=viewthread&tid='.$tid;
...
function getCheckJson()
{
	...
	$mobilecheck['mob_setting_url'] = $_G['setting']['discuzurl']. ( preg_match("%/$%is", $_G['setting']['discuzurl']) ? '': '/' ).'api/mobile/remote.php';
